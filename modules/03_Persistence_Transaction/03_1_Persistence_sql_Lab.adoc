...
[[usecase1]]
=== Query an Apache Derby database using H2 Driver & Apache Camel SQL component

The goal of this use case is to design a Junit Test case

The use czase will be developed using the class +org.jboss.fuse.persistence.jdbc.SelectFromTest.java+ which extend the class +BaseJettyTest+ class.
