...
Finally, we will see how we can secure the endpoint using an API Management platform where we delegate the responsability using some APi plugins to Authenticate the incoming HTTP request using Basic authentication or Oauth2.
