...
The Api that will will register corresponds to our target endpoint that we want to secure. It is encoded and can be documented with its corresponding Swagger JSON/Yaml file. When the Api has been encoded to a specifc
